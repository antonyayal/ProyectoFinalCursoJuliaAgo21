...
# ╔═╡ 57f0cfc0-0a83-4a24-8f8b-e8058291b912
...
# ╔═╡ 27c09d8d-bf55-4d1d-bd1d-9db3f78e5189
veg
...
@bind título TextField((30,2); default="Escribe un título")
...
@bind numero NumberField(1:10; default=8)
...
# ╔═╡ e8aa7d82-f795-4d60-8ed0-7503413cb256
lanzamiento
...
# ╔═╡ b7f7d005-c70d-47de-b86c-1eb63735ab27
...
# ╔═╡ d5bd4907-ac2c-4413-93d5-fb7b0adac26f
LocalResource("/Users/antonioayala/Downloads/Curso Julia/2 Visualizacion/Backends.png", :width => x * x)
...
begin
x_plot4 = 1:10
plot(x_plot4, y_plot4, title = caja_titulo, label = ["Linea 1" "Linea 2"], lw = [1 slider_width], c = [:blue color_grafica2])
end

# ╔═╡ b07a1045-a218-4c49-baea-6456721c6d33
with_terminal(plotattr, :Plot)

# ╔═╡ 42bbfffe-b19f-433a-8f07-a95a5416e914
plotattr(:Plot)
...
x_plot5 = 1:10
y_plot5 = rand(10, 2)
myplot=plot(x_plot5, y_plot5, title = "Dos lineas", label = ["Linea 1" "Linea 2"], lw = 2, 
    c = ["green" "purple"], alpha = [0.8 0.9])
...
savefig("my_plot.svg") #Ultima gráfica en memoria

# ╔═╡ 0616145c-8380-45c0-a62c-43e8ff944288
savefig(myplot,"my_plot.png") #gráfica específica
...
begin
	...
	p3 = plot(x_plot7, y_plot7, xlabel = "¡Esta está tuneada!", lw = 4, title = "Subtítulo", line = :dash)
...
begin
	...
	plot(x_plot8, f.(x_plot8), c = "pink", lw = 4, title = "Graficando con funciones", xlabel = "x", ylabel = L"f(x)", label = L"Ae^(-amortiguacion*x) *cos(\omega x+\phi)")
end
...
begin
	...
	plot([x_plot9 1.02x_plot9], [y_plot9 1.02y_plot9], c = ["red" :red], lw = 4, title = "Corazón", xlabel = "x", ylabel = "f(x)",
...
begin
	plot(x_plot11, y_plot11, line = (3, :dash, :lightblue), marker = (Shape(verts), 30, RGBA(slider_🔴_1, slider_💚_1, slider_💙_1, α)), legend = false)
end
...
begin
	...
	x1_circ,y1_circ = circulo(2)
	
	cir1=plot(x_circ, y_circ,  aspect_ratio = 1, leg = false, fill = true, c = :green, alpha = 0.4)
		
	cir2=plot(x1_circ, y1_circ,  aspect_ratio = 1, leg = false, fill = true, c = :blue, alpha = 0.4)
end

# ╔═╡ 5600fc2b-538e-41d6-9737-ccb3db77eb84
